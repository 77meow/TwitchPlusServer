...
// Video, Stream and Clip share the same property, so we create an Item class
@JsonIgnoreProperties(ignoreUnknown = true)
@JsonInclude(JsonInclude.Include.NON_NULL)
@JsonDeserialize(builder = Item.Builder.class) // When initialize or deserialize, we use builder
public class Item {
    @JsonProperty("id")
